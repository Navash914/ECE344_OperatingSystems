...
struct dinode {
	s32 i_type;
	/* i_block_nr is array of physical block numbers to direct blocks */
	s32 i_block_nr[NR_DIRECT_BLOCKS];
	s32 i_indirect; /* physical block number of an indirect block */
	s32 i_dindirect;/* physical block number of a double indirect block */
